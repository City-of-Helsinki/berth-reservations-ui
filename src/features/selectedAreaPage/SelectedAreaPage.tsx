...
import SelectionPageLegend from '../../components/legends/selectionPageLegend/SelectionPageLegend';
import { WinterAreas, WinterFormValues, WinterStorageType } from '../winterStorageApplication/types';
